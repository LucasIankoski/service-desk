...
- **Fila única**: conjunto de todas as solicitações disponíveis aos atendentes e gestores; não há departamentos na v1.
- **Atendente**: colaborador que assume, classifica, comenta e altera o estado de solicitações.
- **Gestor**: supervisor da fila única, com capacidade de redistribuir solicitações e administrar prazos.
...
- **Nota interna**: comentário visível apenas para atendentes e gestores.
